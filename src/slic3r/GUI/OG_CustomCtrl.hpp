...
class OG_CustomCtrl :public wxPanel
{
    ...
    struct CtrlLine {
        ...
        wxPoint draw_act_bmps(wxDC& dc, wxPoint pos, const wxBitmap& bmp_undo_to_sys, const wxBitmap& bmp_undo, const wxBitmap* bmp_save, bool is_blinking, size_t rect_id = 0);
        ...
        std::vector<wxRect> rects_save_icon;
